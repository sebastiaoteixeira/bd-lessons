INSERT INTO Company_department (Dname, Dnumber, Mgrssn, Mgrstartdate)
VALUES 
...
INSERT INTO Company_employee (Fname, Minit, Lname, Ssn, Bdate, Address, Sex, Salary, Super_ssn, Dno)
VALUES 
...
INSERT INTO Company_dept_locations (Dnumber, Dlocation)
VALUES 
    (2, 'Aveiro'),
    (3, 'Coimbra');


INSERT INTO Company_project (Pname, Pnumber, Plocation, Dnum)
VALUES 
...
INSERT INTO Company_works_on (Essn, Pno, Hours)
VALUES 
    (183623612, 1, 20),
    (183623612, 3, 10),
    (21312332, 1, 20),
...
INSERT INTO Company_dependent (Essn, Dependent_name, Sex, Bdate, Relationship)
VALUES 
